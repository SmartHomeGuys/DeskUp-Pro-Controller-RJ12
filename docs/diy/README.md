...
_Note: The RJ12 clip faces upwards in the table above and in the wiring image below. So Pin 1 (white) is on the left side and pin 6 (blue) is on the right side._
